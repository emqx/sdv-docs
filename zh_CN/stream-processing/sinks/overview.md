...
Sink 用于将处理结果发往外部系统。用户可以直接使用标准内置动作。内置动作的列表如下：
...
| resendDestination    | string: ""                         | 重发数据的目标。该属性在各种 sink 中的含义和支持程度各不相同。例如，在 MQTT sink 中，该属性表示重发的目标主题。                                                                                                                                                                                                                                                                                                             |
